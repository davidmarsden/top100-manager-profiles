...
export default async (req: Request, context: Context) => {
  ...
  try {
    ...
    try {
      ...
      // Sample data for initial setup - FIXED FIELD NAMES
      managersData = [
        {
          id: "scott-mckenzie",
          name: "Scott McKenzie",
          club: "FC Barcelona",  // Fixed: was "clubs"
          division: 1,
          type: "legend",
          points: 2671,
          games: 1096,
        ...
        },
        {
          id: "glen-mullan",
          name: "Glen Mullan",
          club: "Real Madrid",  // Fixed: was "clubs"
          division: 1,
          type: "elite",
          points: 994,
          games: 555,
